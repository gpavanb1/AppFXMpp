...
int main()
{
    ...
    // Create a domain: 80 interior cells, 1 left + 1 right ghost cell, 1 variable "y"
    auto domain = Domain::from_size(80, 1, 1, {"y"}, 0.0, 1.0);
    ...
    {
        std::cout << cell->x() << " " << cell->values().transpose() << "\n";
    }
